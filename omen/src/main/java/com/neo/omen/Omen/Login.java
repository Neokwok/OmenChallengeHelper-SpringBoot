...
import com.neo.omen.Omen.Body.HandshakeBody;
import com.neo.omen.Omen.Body.StartBody;
import com.neo.omen.Utils.HTTP.HttpUtil2;
import com.neo.omen.Utils.HTTP.HttpUtilEntity;
import com.neo.omen.Utils.JsonUtil;
import com.neo.omen.Utils.URLUtil;
    ...
    public void webPrepare(){
        ...
        try {
            ...
            if (!location.isEmpty()) {
                ...
                body.put("flow", location.substring(location.indexOf("=") + 1));
